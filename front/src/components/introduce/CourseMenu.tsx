...
export default function CourseMenu() {
  ...
  return (
    <div className='courseMenu_wrap'>
      ...
      <div onClick={()=>clickedCourseMenu(setNewsMenu)} style={newsMenu} className='courseMenu news'><img className='courseMenuImg' src={`${process.env.PUBLIC_URL}/img/news.png`} alt="news" /><p className='courseText'>뉴스</p></div>
